                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Start EnerGAI Chatting</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>This chatbot knows everything OilWrx knows...and its ready to share</h2>
                            </Stack>
                        ) : (
